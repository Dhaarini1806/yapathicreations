      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        >
          ...
          <p className="font-body text-primary-foreground/70 text-lg mb-10 max-w-xl mx-auto">
            Join our growing global family today.
          </p>
          <a
            href="https://chat.whatsapp.com/DDDYlXIcg6uARjOXaeOFkj"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-3 px-10 py-4 bg-gradient-gold text-foreground font-body font-semibold uppercase tracking-wider text-sm rounded-sm hover:shadow-gold transition-all duration-300 hover:scale-105"
          >
